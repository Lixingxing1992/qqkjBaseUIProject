...
import com.base.ui.org.itemtouchhelper.ItemTouchHelperAdapterCallback;
...
//					ItemTouchHelper.startDrag();
	...
	public MyHolder onCreateViewHolder(ViewGroup parent, int arg1) {
		View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_test_recycleviewtouch, parent, false);
