...
public class BaseRoundAngleImageView extends ImageView {
	...
	public BaseRoundAngleImageView(Context context) {
        super(context);
        init(context, null);
    }

    public BaseRoundAngleImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public BaseRoundAngleImageView(Context context, AttributeSet attrs) {
        super(context, attrs);  
        init(context, attrs);  
    }  
    ...
    private void init(Context context, AttributeSet attrs) {  
        if (attrs != null) {  
        	TypedArray a = context.obtainStyledAttributes(attrs,  
                    R.styleable.BaseRoundAngleImageView);
            roundWidth = a.getDimensionPixelSize(  
                    R.styleable.BaseRoundAngleImageView_roundWidth, roundWidth);
            roundHeight = a.getDimensionPixelSize(  
                    R.styleable.BaseRoundAngleImageView_roundHeight, roundHeight);
            a.recycle();  
        } else {  
