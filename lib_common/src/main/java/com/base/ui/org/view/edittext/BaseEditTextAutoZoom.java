...
public class BaseEditTextAutoZoom extends android.support.v7.widget.AppCompatEditText {
    ...
    public BaseEditTextAutoZoom(final Context context) {
        this(context, null, 0);
    }

    public BaseEditTextAutoZoom(final Context context, final AttributeSet attrs) {
    ...
    public static void setNormalization(final Activity a, View rootView, final BaseEditTextAutoZoom aText) {

        // if the view is not instance of AutoFitEditText
        // i.e. if the user taps outside of the box
        if (!(rootView instanceof BaseEditTextAutoZoom)) {
