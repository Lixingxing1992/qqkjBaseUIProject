package com.base.ui.org.view.imageview;
...
public class BaseNiceImageView extends AppCompatImageView {
    ...
    public void setBorderWidth(int borderWidth) {
        this.borderWidth = BasePrexUtil.dp2px( borderWidth);
    ...
    public void setInnerBorderWidth(int innerBorderWidth) {
        this.innerBorderWidth = BasePrexUtil.dp2px( innerBorderWidth);
        clearInnerBorderWidth();
        invalidate();
    }
    ...
    public void setCornerRadius(int cornerRadius) {
        this.cornerRadius = BasePrexUtil.dp2px( cornerRadius);
        calculateRadiiAndRectF(false);
    }

    public void setCornerTopLeftRadius(int cornerTopLeftRadius) {
        this.cornerTopLeftRadius = BasePrexUtil.dp2px( cornerTopLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopRightRadius(int cornerTopRightRadius) {
        this.cornerTopRightRadius = BasePrexUtil.dp2px( cornerTopRightRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius) {
        this.cornerBottomLeftRadius = BasePrexUtil.dp2px( cornerBottomLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomRightRadius(int cornerBottomRightRadius) {
        this.cornerBottomRightRadius = BasePrexUtil.dp2px( cornerBottomRightRadius);
        calculateRadiiAndRectF(true);
    }
