...
public class BaseRecyclerView  extends ViewGroup {
...
//        设置位置
    ...
    private View obtainView(int row, int width, int height) {
        ...
        //根据这个类型 返回相应View  （布局）
//        初始化的时候 取不到
        View reclyView=recycler.getBaseRecyclerView(itemType);
        ...
        //View不可能为空
//
        view.setTag(R.id.type_item_type,itemType);
        view.setTag(R.id.type_row,row);
//        测量
//VIEW 打tag   row    type
...
//        重绘
    ...
    public void removeView(View view) {
        ...
        int typeView = (int) view.getTag(R.id.type_item_type);
