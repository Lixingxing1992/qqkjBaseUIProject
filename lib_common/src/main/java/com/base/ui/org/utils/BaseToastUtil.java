...
public class BaseToastUtil {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(BaseUIManager.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(BaseUIManager.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(BaseUIManager.getContext(), text, duration);
