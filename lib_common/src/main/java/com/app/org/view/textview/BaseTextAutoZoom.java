package com.app.org.view.textview;
...
public class BaseTextAutoZoom extends android.support.v7.widget.AppCompatEditText {
    ...
    public BaseTextAutoZoom(final Context context) {
        this(context, null, 0);
    }

    public BaseTextAutoZoom(final Context context, final AttributeSet attrs) {
    ...
    public static void setNormalization(final Activity a, View rootView, final BaseTextAutoZoom aText) {

        // if the view is not instance of AutoFitEditText
        // i.e. if the user taps outside of the box
        if (!(rootView instanceof BaseTextAutoZoom)) {
