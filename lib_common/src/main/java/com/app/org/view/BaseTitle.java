...
public class BaseTitle extends AutoFrameLayout {
    ...
    private BaseTextAutoZoom mTvTitle;//Title的TextView控件
    ...
    private void initView(final Context context, AttributeSet attrs) {
        ...
        mTvTitle = (BaseTextAutoZoom) findViewById(R.id.tv_rx_title);
    ...
    private void initAutoFitEditText() {
        ...
        try {
            BaseTextAutoZoom.setNormalization((Activity) getContext(), mRootLayout, mTvTitle);
    ...
    public BaseTextAutoZoom getTvTitle() {
        return mTvTitle;
    }
