...
public class BaseImageLoaderUtil {
    private static BaseImageLoaderUtil _image_util = null;
    ...
    public static BaseImageLoaderUtil getIns(){

        if(null == _image_util){

            _image_util = new BaseImageLoaderUtil();
        }
