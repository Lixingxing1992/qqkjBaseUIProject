...
public class BaseAppUtil {
    ...
    public static void installApp(Context context, String filePath) {
        context.startActivity(BaseIntentUtil.getInstallAppIntent(context, filePath));
    }
    ...
    public static void installApp(Context context, File file) {
        if (!BaseFileUtil.isFileExists(file)) return;
    ...
    public static void installApp(Activity activity, String filePath, int requestCode) {
        activity.startActivityForResult(BaseIntentUtil.getInstallAppIntent(activity, filePath), requestCode);
    }
    ...
    public static boolean installAppSilent(Context context, String filePath) {
        File file = BaseFileUtil.getFileByPath(filePath);
        if (!BaseFileUtil.isFileExists(file)) return false;
        String command = "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install " + filePath;
        BaseShellUtil.CommandResult commandResult = BaseShellUtil.execCmd(command, !isSystemApp(context), true);
    ...
    public static boolean isSystemApp(Context context, String packageName) {
        if (BaseDataUtil.isNullString(packageName)) return false;
        try {
    ...
    public static void uninstallApp(Context context, String packageName) {
        if (BaseDataUtil.isNullString(packageName)) return;
        context.startActivity(BaseIntentUtil.getUninstallAppIntent(packageName));
    }
    ...
    public static void uninstallApp(Activity activity, String packageName, int requestCode) {
        if (BaseDataUtil.isNullString(packageName)) return;
        activity.startActivityForResult(BaseIntentUtil.getUninstallAppIntent(packageName), requestCode);
    }
    ...
    public static boolean isAppRoot() {
        BaseShellUtil.CommandResult result = BaseShellUtil.execCmd("echo root", true);
        if (result.result == 0) {
            return true;
        }
    ...
    public static void launchApp(Context context, String packageName) {
        if (BaseDataUtil.isNullString(packageName)) return;
        context.startActivity(BaseIntentUtil.getLaunchAppIntent(context, packageName));
    }
    ...
    public static void launchApp(Activity activity, String packageName, int requestCode) {
        if (BaseDataUtil.isNullString(packageName)) return;
        activity.startActivityForResult(BaseIntentUtil.getLaunchAppIntent(activity, packageName), requestCode);
    }
    ...
    public static void getAppDetailsSettings(Context context, String packageName) {
        if (BaseDataUtil.isNullString(packageName)) return;
        context.startActivity(BaseIntentUtil.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName(Context context, String packageName) {
        if (BaseDataUtil.isNullString(packageName)) return null;
        try {
            PackageManager pm = context.getPackageManager();
    ...
    public static int getAppVersionCode(Context context, String packageName) {
        if (BaseDataUtil.isNullString(packageName)) return -1;
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static String getAppSignatureSHA1(Context context, String packageName) {
        ...
        return BaseEncryptUtil.encryptSHA1ToString(signature[0].toByteArray()).
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !BaseDataUtil.isNullString(packageName) && packageName.equals(BaseProcessUtil.getForegroundProcessName(context));
    }
    //----------------------------------------------------------------------------------------------------------------
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return !BaseDataUtil.isNullString(packageName) && BaseIntentUtil.getLaunchAppIntent(context, packageName) != null;
    }
    ...
    public static boolean cleanAppData(Context context, File... dirs) {
        boolean isSuccess = BaseFileUtil.cleanInternalCache(context);
        isSuccess &= BaseFileUtil.cleanInternalDbs(context);
        isSuccess &= BaseFileUtil.cleanInternalSP(context);
        isSuccess &= BaseFileUtil.cleanInternalFiles(context);
        isSuccess &= BaseFileUtil.cleanExternalCache(context);
        for (File dir : dirs) {
            isSuccess &= BaseFileUtil.cleanCustomCache(dir);
        }
        return isSuccess;
    }
