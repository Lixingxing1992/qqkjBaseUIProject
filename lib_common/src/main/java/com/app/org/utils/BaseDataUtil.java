...
import com.app.org.consts.BaseConst;
...
import static com.app.org.consts.BaseConst.BYTE;
import static com.app.org.consts.BaseConst.GB;
import static com.app.org.consts.BaseConst.KB;
import static com.app.org.consts.BaseConst.MB;
...
public class BaseDataUtil {
    ...
    public static int[] stringToInts(String s) {
        ...
        if (BaseDataUtil.isNullString(s)) {
     ...
     * @param byteNum 字节数
     * @param unit    <ul>
     *                <li>{@link BaseConst.MemoryUnit#BYTE}: 字节</li>
     *                <li>{@link BaseConst.MemoryUnit#KB}  : 千字节</li>
     *                <li>{@link BaseConst.MemoryUnit#MB}  : 兆</li>
     *                <li>{@link BaseConst.MemoryUnit#GB}  : GB</li>
     *                </ul>
     * @return 以unit为单位的size
     */
    public static double byte2Size(long byteNum, BaseConst.MemoryUnit unit) {
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, BaseConst.MemoryUnit unit) {
        if (size < 0) return -1;
        switch (unit) {
            default:
            case BYTE:
